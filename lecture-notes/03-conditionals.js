...
/* Understanding how our comparison operators are functioning can help us ask questions to produce results we are wanting. 
If the weather is less than 70 degrees outside, we may want to be instructed to wear a jacket. 
...
? Perhaps we want to evaluate a question and provide an option for either the "yes" and "no" of that answer. 
? EX. "If you're tired, sleep.If not, go for a walk." If/Else statements allow us this ability to write out a chain of events.
*/
...
/* The end of the ELSE IF statement should have a simple "Else" to finish it. This is simply stating that none of our conditions were met 
to execute and we should provide a response to those responses we cam't for.
? It should also be considered that it will finish the method once the condition has been met. Remember, JS reads from top to bottom. 
?If passes on a particular Else If, it will consider it completed. 
*/
...
// Challeng 2 Take Home Challenge
/*
    Create a switch staement that taked in a value (number)
    that represents a grade. If it is True, console log that 
    they are passing eith the correct letter grade.
...
switch(true) {
    ...
    case grade < 59:
        ...
        break;
    default:
        console.log('Input is not grade')
}
