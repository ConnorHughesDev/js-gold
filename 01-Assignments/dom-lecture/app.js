...
/*
    Most versitile of all selectors.
    - access first element if there's more than on
...
/*
    ...
    - Not an array but it works like one
        - Can loop through it
...
// shows that HTMLCollection is not an Array even though it acts like it
...
let slectAll = document.querySelectorAll("ul li")
...
/*
    ...
    The reason why is because HTMLCCollection is dynamic wheras NodeList is static.
*/
...
// firstChild drops to first element of the noe
// firstChild nextSibling is in first element of the adjacent element's sobling.
...
/*
    ...
    - Event ==> what happens
    - Callback function ==> fx that does something when tha event occurs.
*/
